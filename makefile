...
MY_LIBS   = -lm -ldl -lrt -lpthread -L$(XILINX_OTHER_LIB_BASE_PATH)/lib $(XILINX_OTHER_LIB_BASE_PATH)/lib/libcurl.a $(XILINX_OTHER_LIB_BASE_PATH)/lib/libz.a $(XILINX_OTHER_LIB_BASE_PATH)/lib/libssl.a $(XILINX_OTHER_LIB_BASE_PATH)/lib/libcrypto.a
